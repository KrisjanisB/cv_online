...
var _require = __webpack_require__(/*! tailwindcss/lib/util/dataTypes */ "./node_modules/tailwindcss/lib/util/dataTypes.js"),
    color = _require.color; // window.Vue = require('vue').default;
//
// /**
...
var addNewItemButtons = document.querySelectorAll(".add-new-input");
addNewItemButtons.forEach(function (item) {
  item.addEventListener("click", function () {
    var lastNode = item.previousElementSibling;
    var nr = parseInt(lastNode.dataset.fieldId);
...
var wrappers = document.querySelectorAll("[data-field-group]");
...
function clearInputs(clone, nr) {
  clone.querySelectorAll("input, textarea, checkbox, select").forEach(function (item) {
    ...
    item.name = item.name.replace(/\[\d+\]/, "[".concat(nr + 1, "]"));
  });
}
